<?php
     ...
     * $file == raw image
     * $path == file location
     * $prefix == A random name like 'CAT'
     * $size == require array, it should be two index [0] for width [1] for height
     * Method == Photo::upload($request->image, 'files/banner', 'BANNER', [851, 380]);
     * @return void
     */
