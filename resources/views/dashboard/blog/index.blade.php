                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" @error('author') is-invalid @enderror" placeholder="Author's Name" name="author">
                                            @error('author')
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" @error('title') is-invalid @enderror" placeholder="Enter blog title" name="title">
                                            @error('title')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
